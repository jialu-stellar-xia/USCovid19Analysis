...
```{r}
Covid19_selected_df$increase_rate = Covid19_selected_df$new_case / Covid19_selected_df$tot_cases
```
```{r}
ggplot(data=Covid19_selected_df, aes(x=X, y = increase_rate, group = state)) + 
